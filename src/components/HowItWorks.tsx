    ...
    <section className="py-20 lg:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <div
            ref={badgeRef}
            className={`inline-flex items-center gap-2 bg-accent/10 border border-accent/20 rounded-full px-4 py-2 mb-4 animate-fade-in-scale ${badgeInView ? 'in-view' : ''}`}
          >
        ...
        <div ref={gridRef}>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              <div
                key={index}
                className={`relative animate-fade-in-up ${gridInView ? 'in-view' : ''}`}
